            ...
            <div class="row g-4" id="container-barang">
                ...
                <div class="col-md-4">
                    <div class="card h-100" data-product-id="1">
                        <img src="assets/Buket Romantis Pink.jpg" class="card-img-top" alt="Buket Romantis Pink"
                ...
                <div class="col-md-4">
                    <div class="card h-100" data-product-id="2">
                        <img src="assets/Buket Elegan Ungu.jpg" class="card-img-top" alt="Buket Elegan Ungu"
                             style="height: 220px; object-fit: cover;">
                        <div class="card-body d-flex flex-column">
                ...
                <div class="col-md-4">
                    <div class="card h-100" data-product-id="3">
                        <img src="assets/Buket Passion Merah.jpg" class="card-img-top" alt="Buket Passion Merah"
                             style="height: 220px; object-fit: cover;">
                        <div class="card-body d-flex flex-column">
